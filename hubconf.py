...
Usage:
    ...
    model = torch.hub.load('ultralytics/yolov5', 'custom', 'yolov5s_m_train_coco.pt')  # custom/local model
    model = torch.hub.load('.', 'custom', 'yolov5s_m_train_coco.pt', source='local')  # local repo
"""
